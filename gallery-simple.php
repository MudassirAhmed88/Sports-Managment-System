                        ...
                        <div class="col-md-12">
                            ...
                            <div class="ritekhela-gallery ritekhela-gallery-view1">
                                <ul class="row">
                                    ...
                                    <li class="col-md-3">
                                        <figure>
                                            <a data-fancybox-group="group" href="admin/image/gallery/<?php echo $image; ?>" class="fancybox"><img src="admin/image/gallery/<?php echo $image; ?>" alt=""> <i class="fa fa-plus ritekhela-bgcolor"></i> </a>
